...
background2_path=os.path.join(current_dir, "img","bg001.png")
background3_path=os.path.join(current_dir, "img","grass.png")
background4_path=os.path.join(current_dir, "img","desert.png")
...
background2_png=pygame.image.load(background2_path).convert()
background3_png=pygame.image.load(background3_path).convert()
background4_png=pygame.image.load(background4_path).convert()
